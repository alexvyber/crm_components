defmodule CrmComponents.Heroicons.Outline do
  @moduledoc """
  Icon name can be the function or passed in as a type eg.
  <CrmComponents.Heroicons.Solid.home class="w-5 h-5" />
  <CrmComponents.Heroicons.Solid.render icon="home" class="w-5 h-5" />

  <CrmComponents.Heroicons.Outline.home class="w-6 h-6" />
  <CrmComponents.Heroicons.Outline.render icon="home" class="w-6 h-6" />
  """
